 ...
 */
   ...
   private Information<Integer> dt = new Information<Integer>() ;//d�calage des trajets multiples
         ...
         for (int i=0;i<args.length;i++){ // pour chaque argument, nous faisons un traitement
            ...
            if (args[i].matches("-s")){ // indique si on souhaite l'affichage des sondes
               ...
               if (args[i].matches("[0,1]{7,}")) {
            	...
            	if(snr<-300) throw new ArgumentsException("Valeur du parametre -snr invalide : Le snr ne peut pas �tre inf�rieur � -300 ");       	
            }
