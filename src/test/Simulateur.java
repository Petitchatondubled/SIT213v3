 ...
 */
   ...
   private int nbTraj= 1; //nombre de trajectoires souhait�s
   private LinkedList<Integer> dt= new LinkedList<Integer>();//liste des retards
   private LinkedList<Float> ar= new LinkedList<Float>();//liste des att�nuations
            ...
            if (args[i].matches("-s")){ // indique si on souhaite l'affichage des sondes
               ...
               if (args[i].matches("[0,1]{7,}")) {
            	...
            	snr = new Float(args[i]) ;
              	...
              	int z=i;
               	nbTraj= new Integer(args[z]);//Le nombre de trajectoire souhait�e
        		i++;
